...
{
    public partial class frmReporteVentasUsuarioEntreFechas : MetroFramework.Forms.MetroForm
    {
        clsReportes reportes = new clsReportes();
        public frmReporteVentasUsuarioEntreFechas()
        {
            InitializeComponent();
        }
        ...
        private void CargarGrid()
        {
            try
            {
                ...
                DataTable compras = reportes.ObtenerVentasEntreFechasPorUsuario(idUsuario, fechaInicio, fechaFin);
        ...
        private void frmReporteVentasUsuarioEntreFechas_Load(object sender, EventArgs e)
        {
